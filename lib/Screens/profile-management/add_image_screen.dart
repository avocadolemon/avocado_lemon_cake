...
Widget firstStage(BuildContext context) {
  Size size = MediaQuery.of(context).size;
  return Stack(
    children: [
      Container(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      for (int i = 0; i < 3; i++)
                        (i == 0 ? circleBar(true) : circleBar(false)),
                    ],
                  ),
...
Widget secondStage(BuildContext context) {
  Size size = MediaQuery.of(context).size;
  return Stack(
    children: [
      Container(
...
Widget thirdStage(BuildContext context) {
  Size size = MediaQuery.of(context).size;
  return Padding(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(width: size.width / 2 - 155),
              for (int i = 0; i < 3; i++)
                (i == 2 ? circleBar(true) : circleBar(false)),
            ],
          ),
          SizedBox(height: 13.h),
          Row(
